...
window.addEventListener("keydown", (e) => {
  if (e.key === "ArrowUp" || e.key.toLowerCase() === "w") rpUp = true;
  if (e.key === "ArrowDown" || e.key.toLowerCase() === "s") rpDown = true;
});
window.addEventListener("keyup", (e) => {
  if (e.key === "ArrowUp" || e.key.toLowerCase() === "w") rpUp = false;
  if (e.key === "ArrowDown" || e.key.toLowerCase() === "s") rpDown = false;
});
